...
<?php
//M��ritet��n nykeisen k�ytt�j�n email ja etunimi asd1 ja asd2 arvoiksi.
...
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    ...
    " - Ik�: " . $row["userAge"]. " - Sukupuoli: " . $row["userGender"]."<br>";
  }
  //Jos tietoja ei ole tulostetaan "Ei profiilitietoja".
} else {
